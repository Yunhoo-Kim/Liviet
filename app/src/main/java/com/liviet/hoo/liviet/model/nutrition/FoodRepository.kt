...
//        }
    ...
    private fun initFoods(){
        ...
        ,image_url = "apple.png", measure = "g", na = 10.0f, protein = 10.0f, resource_id = R.drawable.apple))

        foodDao.insert(Food(name = "고구마", amount = 100, carbon_hydrate = 10f, cal = 10f, fat = 10f
                ,image_url = "apple.png", measure = "g", na = 10.0f, protein = 10.0f, resource_id = R.drawable.sweet_potato))

        foodDao.insert(Food(name = "브로콜리", amount = 100, carbon_hydrate = 10f, cal = 10f, fat = 10f
                ,image_url = "apple.png", measure = "g", na = 10.0f, protein = 10.0f, resource_id = R.drawable.broccoli))

        foodDao.insert(Food(name = "파프리카", amount = 100, carbon_hydrate = 10f, cal = 10f, fat = 10f
                ,image_url = "apple.png", measure = "g", na = 10.0f, protein = 10.0f, resource_id = R.drawable.paprika))
